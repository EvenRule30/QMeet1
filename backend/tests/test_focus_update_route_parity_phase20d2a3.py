...
class FocusUpdateRouteParityPhase20D2A3Tests(unittest.TestCase):
    ...
    def test_reported_bird_house_phrase_routes_to_verified_update_command(self) -> None:
        self.assert_title_update(
            "rename my focus to building a bird house",
